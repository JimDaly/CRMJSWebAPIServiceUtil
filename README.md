...
initial load of the library. Of course, once the library is cached in the user's browser
...
so it will match a different environment. Frankly, I haven't tested this enough to know what kind of issues
might exist here.
...
I've had a relatively long time to get familiar with the Web API since it was first introduced as a preview feature in CRM 2015. I've 
