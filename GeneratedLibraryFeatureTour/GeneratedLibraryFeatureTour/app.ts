...
function trackPropertyChanges() {
    return new Promise(function (resolve, reject) {
        ...
        */
        ...
        ns.createAndRetrieveTypedEntity(
            contosoAccount, //The entity to create. This must be a class. Simple JSON will not work.
            ...
            .then(function (response) {
                ...
                */
                ...
                contosoAccount = <Demo.Tour.account>response;
                console.log(
                    "%s is a %s",
                    contosoAccount.name,
            ...
            .then(function () {
                ...
                */
                ...
                return ns.retrieveTypedEntity(
                    ...
                    */
                    ["name", "customertypecode", "address1_city", "modifiedon"],
                    null,
                    true
                );
            })
            .then(function (response) {
                ...
                */
                console.log(
                    " %s is a %s in %s modified on %s.",
                    contosoAccount.name,
                    contosoAccount.getFormattedValue("customertypecode"),
                    contosoAccount.address1_city,
                    contosoAccount.getFormattedValue("modifiedon")
                );
            ...
            .then(function () {
                ...
                */
                ...
                return ns.retrieve(
                    contosoAccount.getUri(),
                    ["name", "customertypecode", "address1_city", "modifiedon", "accountnumber"],
                    null,
                    true
                );
...
function usingEntities() {
    ...
    return new Promise(function (resolve, reject) {
        ...
        */
        ...
        console.log("lat/long: (%s,%s)",
            jackJonesContact.get("address1_latitude"),
            jackJonesContact.get("address1_longitude"));
        ...
        */
        ...
        ns.create(jackJonesContact)
            .then(function (uri) {
                ...
                */
                contactProperties
                    .splice(
                    contactProperties
                        .indexOf(jjContact.properties.address1_composite.name),
                    1);
            ...
            .then(function (response) {
                ...
                console.log("Parent contact URI: %s",
                    jackJonesContact.parentcustomerid_contact.getUri());
