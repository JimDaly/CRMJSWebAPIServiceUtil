    ...
    ns.create(contact1)
        ...
        .then(function (response) {
            ...
            console.log("Contact '%s' retrieved:\n"
                ...
                contact1.getFormattedValue("annualincome"),
                contact1.jobtitle,
        ...
        .then(function (value) {
            ...
            return ns.createAndRetrieveTypedEntity(
                account1,
                account1.getColumnSet()
            );
        })
        .then(function (entity) {
            account1 = <Sdk.Sample.account>entity;
            ...
            return ns.retrieve(
                account1.getUri(),
                ["name", "telephone1"],
                ["primarycontactid($select=" + contact1.getColumnSet() + ")"],
                true
            );
        })
        .then(function (entity) {
            ...
            return ns.createAndRetrieveTypedEntity(
                account2,
                account2.getColumnSet(),
                ["primarycontactid($select=" + contact2.getColumnSet() + ")"],
                true
            );
        })
        .then(function (entity) {
            ...
            console.log("Account '%s' has primary contact '%s':\n"
                ...
                contact2.fullname,
                contact2.jobtitle,
                contact2.getFormattedValue("annualincome"));

            return ns.retrieve(
                contact2.getUri(),
                contact2.getColumnSet(),
                ["Contact_Tasks($select=" + new ns.task().getColumnSet() + ")"],
                true
            );
        })
        .then(function (entity) {
            ...
            contact2.Contact_Tasks.forEach(function (t) {
                ...
                console.log("Subject: %s \n"
                    ...
                    task.subject,
                    task.description,
                    task.getFormattedValue("scheduledstart"), //Bug: These 'formatted' values are the same as the raw values
            ...
            return ns.addToCollection(
                account2.getUri(), //Fourth Coffee
                account2.collections.contact_customer_accounts.name,
                contact1.getUri()); //Peter Cambel
        })
        .then(function () {
            console.log(
                "Contact '%s' associated to account '%s'.",
                contact1.fullname,
                account2.name
            );
        ...
        .then(function () {
            console.log(
                "Contact '%s' disassociated from account '%s'.",
                contact1.fullname,
                account2.name
            );
        ...
        .then(function () {
            console.log(
                "Opportunity '%s' associated with competitor '%s'.",
                opportunity.name,
                competitor.name
            );
            ...
            return ns.retrieve(
                competitor.getUri(),
                competitor.getColumnSet(),
                ["opportunitycompetitors_association($select=" + opportunity.getColumnSet() + ")"],
                true
            );
        })
        .then(function (entity) {
            ...
            return ns.disassociate(
                opportunity.getUri(),
                opportunity.collections.opportunitycompetitors_association.name,
                competitor.getUri()
            );
        })
        .then(function () {
            ...
            console.log(
                "Opportunity '%s' disassociated with competitor '%s'",
                opportunity.name,
                competitor.name
            );
